/**
 * Test driver utility from unstorage
 * 
 * This is a wrapper around unstorage's testDriver utility.
 * The implementation is copied from unstorage's test suite to ensure
 * compatibility with unstorage's expected driver behavior.
 * 
